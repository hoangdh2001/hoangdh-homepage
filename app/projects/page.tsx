      ...
      <div className="mx-auto w-full sm:max-w-[768px]">
        <div>
          <div className="space-y-2 pb-4 pt-6 md:space-y-5">
            <Breadcrumb />
            <GithubCalendar username="hoangdh2001" />
          </div>
          <div className="py-1">
                    ...
                    <div className="w-full flex-shrink-0 sm:block sm:w-auto">
                      {project.href ? (
                        ...
                        >
                          <Image
                            alt={project.title}
                            src={project.imgSrc || '/static/images/robot.png'}
                            className="aspect-video h-[140px] w-full rounded-lg border border-gray-200 object-cover object-center dark:border-gray-800 sm:w-[210px]"
                            width={210}
                            height={140}
                          />
                        </Link>
